...
public class EventControllerTests extends BaseControllerTest {
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("limitOfEnrollment").description("Limit of new event enrollment")
                        ),
                        responseHeaders(
    ...
    public void createEvent_bad_request_wrong_input() throws Exception {
        EventDto eventDto = EventDto.builder()
                .name("Spring")
                .description("REST API Development with Spring")
                .beginEnrollmentDateTime(LocalDateTime.of(2023, 4, 24, 1, 54, 00))
    ...
    public void getEvent() throws Exception {
        ...
        // When & Then
        mockMvc.perform(MockMvcRequestBuilders.get("/api/events/{id}", event.getId()))
                .andExpect(status().isOk())
    ...
    public void getEvent404() throws Exception {
        // When & Then
        mockMvc.perform(MockMvcRequestBuilders.get("/api/events/7698"))
    ...
    public void updateEvent() throws Exception {
        ...
        // When & Then
        mockMvc.perform(MockMvcRequestBuilders.put("/api/events/{id}", event.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    @Test
    @TestDescription("입력값이 잘못 된 경우에 이벤트 수정 실패")
    ...
    public void updateEvent404() throws Exception {
        ...
        // When
        mockMvc.perform(MockMvcRequestBuilders.put("/api/events/1513521")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound());
